      ...
      <div className="container mx-auto">
        <div className="grid grid-cols-1 md:grid-cols-2 md:space-y-8 space-y-6 ">
         <div className=' flex justify-start items-center'>
            <Image src={img1} alt='banner' className='w-[400px] h-full object-cover ' />
         </div>
...
//           </div>
//           {/* Text Section */}
//           <div className=' flex flex-col items-center md:items-start justify-start text-left space-y-2 lg:max-w-[500px]'>
//             <p className=' text-start'>Customize Your Scheduled</p>
//             <h1 className=' text-2xl md:text-2xl font-bold  text-center md:text-start'>
//               Personalized Professional Online Tutor on Your Schedule
//             </h1>
//             <p className=' text-xs md:text-lg font-bold text-center md:text-start'>
